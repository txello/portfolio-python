...
2. Активные проекты  
   ...
   2.3. [Очередь задач](#очередь-задач)
...
## Активные проекты [(наверх)](#оглавление)
### Шифрование
...
### Очередь задач [(наверх)](#оглавление)
* [QTasks](https://github.com/txello/qtasks) - Фреймворк очередей задач.\
  Использует архитектуру компонентов, основные из которых: `Воркер`, `Брокер`, `Хранилище` и `Стартер`.
